...
SENSOR_TOKEN=(Sensor token used to make registering data easier)
SENSOR_EMAIL=(Email used for notifications sent to sensors)
JWT_SECRET=(Secret used to generate JWT)
MAIL_ADDRESS=(Email address to send notifications from)
