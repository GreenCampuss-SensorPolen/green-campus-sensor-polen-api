...
let Notification = class Notification {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { notificationId: { required: true, type: () => Number }, time: { required: false, type: () => Date }, user: { required: true, type: () => require("../../userData/entities/user.entity").User }, userId: { required: true, type: () => Number }, sendEmail: { required: false, type: () => Boolean }, read: { required: false, type: () => Boolean }, title: { required: true, type: () => String }, description: { required: true, type: () => String } };
    }
};
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_entity_1.User, user => user.notifications, { nullable: false }),
